...
class DataTransformation:
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        """
        It initialises a KNNImputer object with the parameters specified in the traiing_pipeline.py file
        ...
        """
        logging.info(
            "Entered fet_data_transformer_object method as Transformation class"
            )
        try:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            # c_ combines the mentioned inputs
